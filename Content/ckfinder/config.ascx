...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // Thiết lập cấu hình
        finder.basePath = '~/Content/ckfinder/'; // Đường dẫn đến thư mục CKFinder
        // Bắt đầu CKFinder khi trang tải xong
        BrowseServer(finder);
    });

    function BrowseServer(finder) {
        // Sử dụng finder.browse() để mở CKFinder
        finder.browse();
    }
</script>